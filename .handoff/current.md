...
2. [Batch 2 正式详细设计](../docs/development/batch2-training-data-and-sampling-tasks.md)
3. [Batch 2 ticket 总入口](../.scratch/batch2-training-data-and-sampling/spec.md)
4. [Batch 2 Agent 施工规范](../.scratch/batch2-training-data-and-sampling/AGENT_IMPLEMENTATION_GUIDE.md)
5. [Batch 2 首个 ticket：基线与 fixture](../.scratch/batch2-training-data-and-sampling/issues/01-baseline-and-fixtures.md)
