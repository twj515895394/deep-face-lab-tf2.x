...
> 当前状态：wave1-code-pass + t18/t20-impl-awaiting-review；Windows smoke `test_batch*.py` PASS；**Windows SAEHD GPU 最终验收 PENDING**（Ticket 21 未 resolved；禁止 Batch 2 DONE）  
