if __name__ == "__main__":
    ...
    def process_extract(arguments):
        ...
        Extractor.main( detector                = arguments.detector,
                        ...
                        workers_per_gpu         = arguments.workers_per_gpu,
                      )
    ...
    p.add_argument('--output-debug', action="store_true", dest="output_debug", default=None, help=r"Writes debug images to <output-dir>_debug\ directory.")
    p.add_argument('--no-output-debug', action="store_false", dest="output_debug", default=None, help=r"Don't writes debug images to <output-dir>_debug\ directory.")
    ...
    p.add_argument('--manual-output-debug-fix', action="store_true", dest="manual_output_debug_fix", default=False, help=r"Performs manual reextract input-dir frames which were deleted from [output_dir]_debug\ dir.")
    ...
    p.add_argument('--workers-per-gpu', type=int, dest="workers_per_gpu", default=1, help="Number of worker processes per GPU. Default: 1. Increase to 2-3 for better GPU utilization, but requires more GPU memory.")
    ...
    def process_merge(arguments):
        ...
        Merger.main ( model_class_name       = arguments.model_name,
                      ...
                      cpu_only               = arguments.cpu_only,
                      stco_enabled           = arguments.stco,
                      stco_strength          = arguments.stco_strength)
    ...
    p.add_argument('--force-gpu-idxs', dest="force_gpu_idxs", default=None, help="Force to choose GPU indexes separated by comma.")
    p.add_argument('--stco', action="store_true", dest="stco", default=False, help="Enable STCO (Skin Tone Consistency Optimization) for automatic color correction.")
    p.add_argument('--stco-strength', type=float, dest="stco_strength", default=0.8, help="STCO correction strength (0.0-1.0). Default 0.8. Higher values correct more aggressively.")
