...
def main (model_class_name=None,
    ...
    try:
        ...
        if hasattr(model, 'switch_to_merge_mode'):
            model.switch_to_merge_mode()
        elif hasattr(model, 'release_training_resources'):
            model.release_training_resources()
        ...
        if len(frames) == 0:
            ...
            if False:
                ...
                InteractiveMergerSubprocessor (
                            ...
                            stco_enabled           = stco_enabled,
                            stco_strength          = stco_strength,
                        ).run()
