...
def generate_synthetic_landmarks(pose_type="center"):
    ...
    # Simple predefined face outline and features in 256x256 space
    center_x, center_y = 128.0, 128.0

    if pose_type == "left_yaw":
        center_x -= 30.0
    elif pose_type == "right_yaw":
        center_x += 30.0
...
def build_ordinary_fixture(target_dir):
    ...
    configs = [
        ...
        ("00002_left.jpg", "clear", "left_yaw", FaceType.FULL, "frame_002.png"),
        ("00003_right.jpg", "clear", "right_yaw", FaceType.FULL, "frame_003.png"),
        ("00004_blur.jpg", "blur", "center", FaceType.FULL, "frame_004.png"),
        ("00005_dark.jpg", "dark", "center", FaceType.FULL, "frame_005.png"),
        ...
        ("00010_head.jpg", "clear", "center", FaceType.HEAD, "frame_010.png"),
    ]
